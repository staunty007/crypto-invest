        ...
        <div class="top_header_right_wrapper dashboard_right_Wrapper">
           <div class="crm_message_dropbox_wrapper">
                ...
                <div class="crm_profile_dropbox_wrapper">
                    <div class="nice-select" tabindex="0"> <span class="current"><img src="{{ URL::asset('auth/images/avatar.png') }}" alt="img"> {{ Auth::user()->name }} ! <span class="hidden_xs_content"></span></span>
                        <ul class="list">

                            <li><a href="{{ route('profile') }}"><i class="flaticon-profile"></i> Profile</a>
                            </li>
                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i class="flaticon-turn-off"></i> Logout</a>
                            </li>
                        </ul>
                    </div>
                </div>
