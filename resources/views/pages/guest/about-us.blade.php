        ...
        <div class="row row-vm">
            <div class="col-md-5 res-m-bttm">
                <div class="text-block">
                    <h2>About Crystal<span>Capital</span></h2>
            ...
            <div class="col-md-6 col-md-offset-1">
                <div class="video-block round">
                    <img src="https://source.unsplash.com/random/600x400" alt="photo-md" class="img-shadow">
                    <a href="https://youtu.be/L-Qhv8kLESY" class="video-play"><span class="pe pe-7s-play"></span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 res-m-bttm">
                <div class="team-member">
                    ...
                    <div class="team-info">
                        <h5 class="team-name">Alex Greg</h5>
                        <span class="team-title">Co-Founder|CIO</span>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-8 col-md-offset-2">
                ...
                <a href="https://www.luno.com/wallet/" class="btn btn-md">buy bitcoin</a>
            </div>
        </div>
    </div>
</div>
